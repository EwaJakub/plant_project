from plant_app.models import Category, Plant, ANIMAL_INFLUENCE, AIR_PURIFYING, WindowSide, HomeRoom, RoomPart, ScrapyJungleBoogie
...
def global_vars(request):
    return {
        ...
        'joongle': ScrapyJungleBoogie.objects.all()
    }
